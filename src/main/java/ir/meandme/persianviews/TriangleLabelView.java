...
/**
 * Created by Mostafa on 12/22/2017.
 */
...
//            }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        this.backGroundColor = ta.getColor(R.styleable.TriangleLabelView_backgroundColor, Color.parseColor("#EF4836"));
        ...
        this.primary.initPaint(context);
        this.secondary.initPaint(context);
    ...
    public PaintHolder getPrimary(){return primary;}
    ...
    public void setPrimaryTextColor(@ColorInt int color) {
        primary.color = color;
        primary.initPaint(this.context);
        primary.resetStatus();
        relayout();
    }
    ...
    public void setSecondaryTextColor(@ColorInt int color) {
        ...
        secondary.initPaint(this.context);
        secondary.resetStatus();
        relayout();
    }
